...
If you have not already explored the codebase, do so to understand the current state of the code. Ticket titles and descriptions should use the project's `CONTEXT.md` domain glossary vocabulary, and respect ADRs in the area you're touching.
...
Create one GitHub issue per ticket, in dependency order (blockers first, so their numbers exist for references):
...
- [ ] Criterion 1 (machine-checkable: name the test or command that proves it)
- [ ] Criterion 2
